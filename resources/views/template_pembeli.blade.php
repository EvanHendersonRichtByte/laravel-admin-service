  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
        ...
        <div class="sidebar-brand-text mx-3">Online Rent Car<!-- <sup>Skip</sup> --></div>
      </a>
      ...
      <!-- Nav Item - Charts -->
      <li class="nav-item">
        <a class="nav-link" href="{{url('/rent')}}">
          <i class="fas fa-handshake fa-handshake-area"></i>
      ...
      <li class="nav-item">
        <a class="nav-link" href="{{url('logout')}}">
          <i class="fas fa-sign-out-alt fa-sign-out-alt-area"></i>
          <span>Logout</span></a>
      </li>
